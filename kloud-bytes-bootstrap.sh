...
cat >>/etc/hosts<<EOF
192.168.51.100   k8s51-master.example.com     k8s51-master  km1
192.168.51.101   k8s51-worker1.example.com    k8s51-worker1 kw1
192.168.51.102   k8s51-worker2.example.com    k8s51-worker2 kw2
192.168.51.103   k8s51-worker3.example.com    k8s51-worker3 kw3
192.168.51.104   k8s51-worker4.example.com    k8s51-worker4 kw4
EOF
